...
public interface InclusionConfigurer {
    ...
    /**
     * Registers a custom {@link InclusionResolver}. Some objects may not be relevant
     * or suitable for the comparison process. Using an {@link InclusionResolver} is a
     ...
     * InclusionResolver}. If performance is important to you, make sure that calling
    ...
    public interface ToInclude {
         ...
         * @see ObjectDiffProperty#inclusion()
         */
    ...
    public interface ToExclude {
         ...
         * @see ObjectDiffProperty#inclusion()
         * @see ObjectDiffProperty#excluded()
         */
