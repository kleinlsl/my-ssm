...
public @interface ObjectDiffProperty {
    /**
     * Causes the {@link Differ Differs} to skip the marked property and all its children.
     *
     ...
     */
    @Deprecated public boolean excluded() default false;

    public Inclusion inclusion() default Inclusion.DEFAULT;

    /**
     * Causes the {@link Differ Differs} to compare the object by using the {@link
