...
/**
 * Serves as factory for objects. It is mainly used when {@link DiffNode#canonicalSet(Object,
...
public interface InstanceFactory {
     ...
     * the type. In case of the latter, the {@link ObjectDiffer} will automatically fallback to
