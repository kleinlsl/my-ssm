...
package com.tujia.myssm.core.diff.danielbechler.util;
...
public final class Classes {
    ...
    private static final Collection<Class<?>> EXTENDABLE_SIMPLE_TYPES = asList(BigDecimal.class, BigInteger.class, CharSequence.class,
    ...
    @SuppressWarnings("unchecked")
    private static final List<Class<? extends Serializable>> FINAL_SIMPLE_TYPES = asList(Class.class, URI.class, URL.class, Locale.class, UUID.class);
    ...
    public static <T> T freshInstanceOf(final Class<T> clazz) {
        ...
        try {
            ...
            //			logger.debug("Missing default constructor for type {}. Assuming standard default values " + "for primitive properties.", clazz.getName());
            return null;
        }
