...
import com.tujia.myssm.core.diff.danielbechler.diff.identity.EqualsIdentityStrategy;
...
public class CollectionItemAccessor implements TypeAwareAccessor, Accessor {
     ...
     */
    public CollectionItemAccessor(final Object referenceItem, final IdentityStrategy identityStrategy) {
