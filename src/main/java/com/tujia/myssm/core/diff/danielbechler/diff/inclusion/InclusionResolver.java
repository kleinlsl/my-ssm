 ...
 * comparison process. Using an {@link InclusionResolver} is a powerful and flexible
 ...
 * InclusionResolver}. If performance is important to you, make sure that calling its
 * methods is as cheap as possible.
 */
public interface InclusionResolver {
    /**
     * Determines whether a given {@link DiffNode} should be included into the comparison
     * process.
     *
     * @param node The node to determine the inclusion for. Keep in mind that the {@link
     *             DiffNode} doesn't contain any children at this point and
     ...
     *             nodes.
     * @return Returns either {@link Inclusion#INCLUDED} to indicate an explicit
     * inclusion, {@link Inclusion#EXCLUDED} to inidicate an explicit exclusion or
     * {@link Inclusion#DEFAULT} in case this resolver doesn't want to influence the
     ...
     * explicitly included via {@link Inclusion#INCLUDED}. Otherwise nodes with {@link
     * Inclusion#DEFAULT} will also be included.
     */
