...
import com.tujia.myssm.core.diff.danielbechler.diff.access.MapEntryAccessor;
...
public final class MapDiffer implements Differ {
    ...
    public final DiffNode compare(final DiffNode parentNode, final Instances instances) {
        ...
        if (instances.hasBeenAdded()) {
            ...
            comparisonStrategyResolver.resolveComparisonStrategy(mapNode).compare(mapNode, instances.getType(), instances.getWorking(Map.class),
