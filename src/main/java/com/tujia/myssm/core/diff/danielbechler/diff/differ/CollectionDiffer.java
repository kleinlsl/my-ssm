...
import com.tujia.myssm.core.diff.danielbechler.diff.access.CollectionItemAccessor;
...
import com.tujia.myssm.core.diff.danielbechler.diff.identity.IdentityStrategyResolver;
...
public final class CollectionDiffer implements Differ {
    ...
    public CollectionDiffer(final DifferDispatcher differDispatcher, final ComparisonStrategyResolver comparisonStrategyResolver,
    ...
    private static void compareUsingComparisonStrategy(final DiffNode collectionNode, final Instances collectionInstances,
                                                       final ComparisonStrategy comparisonStrategy) {
        comparisonStrategy.compare(collectionNode, collectionInstances.getType(), collectionInstances.getWorking(Collection.class),
    ...
    private void compareItems(final DiffNode collectionNode, final Instances collectionInstances, final Iterable<?> items,
