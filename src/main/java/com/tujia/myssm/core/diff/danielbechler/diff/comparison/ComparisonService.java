...
import com.tujia.myssm.core.diff.danielbechler.diff.introspection.ObjectDiffEqualsOnlyType;
...
import com.tujia.myssm.core.diff.danielbechler.diff.path.NodePathValueHolder;
import com.tujia.myssm.core.diff.danielbechler.util.Classes;
...
public class ComparisonService implements ComparisonConfigurer, ComparisonStrategyResolver, PrimitiveDefaultValueModeResolver {
    ...
    public ComparisonStrategy resolveComparisonStrategy(final DiffNode node) {
        ...
        final ComparisonStrategy comparisonStrategyFromObjectDiffPropertyAnnotation = comparisonStrategyResolver.comparisonStrategyForAnnotation(
                objectDiffProperty);
        ...
        if (valueType != null) {
            ...
            final ComparisonStrategy comparisonStrategyFromObjectDiffEqualsOnlyTypeAnnotation = comparisonStrategyResolver.comparisonStrategyForAnnotation(
