...
import com.tujia.myssm.core.diff.danielbechler.util.Collections;
...
public class Instances {
    ...
    Instances(final Accessor sourceAccessor, final Object working, final Object base, final Object fresh) {
    ...
    public Class<?> getType() {
        ...
        logger.info("Detected instances of different types " + types + ". " + "These objects will only be compared via equals method.");
        return Object.class;
    }
